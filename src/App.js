...
function App() {
  ...
  return (
    <div className="App">
      ...
      <h1 className="ajou">Ajouter un nouveau film au bibliotheque.</h1>
      <AddCard handleAdd={handleAdd} />
      <Card3 movieCard3={movieCard3} />

      <div className="recherche">
        <h1 className="ajou">Chercher un film</h1>
        <input
          className="input"
          type="text"
  ...
  isHalf={true}/>,
    ...
    {movieCard2.filter((val) =>
      ...
      <div className="footer">
        ...
        <h1>Il y a encore plus de choses à découvrir.</h1>
        <p className="pfooter">
